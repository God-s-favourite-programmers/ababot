...
class Event():
    def __init__(self, name:str, description:str, event_time:datetime.datetime, event_location:str, registration_open:datetime.datetime, url:str, thumbnail:str) -> None:
        self.name:str = name
